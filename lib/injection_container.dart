...
Future<void> init() async {
  ...
  getIt.registerLazySingleton(
      () => CallDS(firebaseFunctions: FirebaseFunctions.instance));
  ...
  getIt.registerLazySingleton(() => GroupsService(
      groupsDS: getIt.get<GroupsDS>(), authService: getIt.get<AuthService>()));
  ...
  getIt.registerLazySingleton(() => AuthService(
        ...
        notificationsController: getIt.get<NotificationsService>(),
        usersDS: getIt.get<UsersDS>(),
      ));
}
